...
function ExportBookData(collection, jsonPath)
  ...
  for _, photo in ipairs(collection:getPhotos()) do
    ...
    photo_record.idConfidence = photo:getPropertyForPlugin("org.krefting.plant-book", "idConfidence")
    photo_record.introduced = photo:getPropertyForPlugin("org.krefting.plant-book", "introduced")
    photo_record.introductionYear = photo:getPropertyForPlugin("org.krefting.plant-book", "introductionYear")
